...
\newcommand{\apj}{ApJ}
\usepackage{xcolor}
\usepackage[labelfont={color=cobalt,bf}, font=scriptsize]{caption}
\usepackage{subcaption}
\usepackage{listings}
\lstset{
language=Python, 
backgroundcolor=\color{cobalt!9}, basicstyle=\ttfamily\footnotesize, keywordstyle=\color{cobalt}\bfseries, commentstyle=\color{gray}\itshape, stringstyle=\color{purple}, 
% numbers=left, 
...
Agli educatori, \par che hanno il potere di piantare nei giovani il seme di un sogno.\par
\medskip
Alle famiglie \par che li sostengono e li incoraggiano nel perseguirlo.\par
\medskip
